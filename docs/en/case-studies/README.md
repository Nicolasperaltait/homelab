...
| [04 - Storage migration, observability and controlled reboot](04-storage-migration-observability-and-controlled-reboot.md) | sensitive changes with rollback, observability and post-reboot validation |
